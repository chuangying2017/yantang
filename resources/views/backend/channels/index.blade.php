...
@section('content')
    <div class="row">
        <div class="col-md-2">
            <a href="{!!route('admin.channels.create')!!}" class="btn btn-primary btn-block margin-bottom">创建新的品牌频道</a>
            <!-- /. box -->
        </div>
        <!-- /.col -->
        <div class="col-md-12">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a target="_blank"
                                               href="{{ env('CLIENT_PC_DOMAIN') . 'products?brand_id=' . $channel->id}}"
                                               class="btn btn-default btn-sm"><i
                                                    class="fa fa-eye"></i></a>
                                            <form style="display: inline-block"
                                                  action="{{url('/admin/channels/' . $channel->id)}}" ,
                                                  method="post">
