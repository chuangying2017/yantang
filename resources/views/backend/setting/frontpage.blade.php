                        ...
                        <div class="col-sm-10">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" value="http://www.google.com/meizhuang">
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="home-banner">
                                            <img src="http://7xp47i.com1.z0.glb.clouddn.com/banner-1.jpg" alt=""
                                                 class="home-slider">
                                        </div>
                                    </td>
                                    <td>http://www.google.com/huli</td>
                                    ...
                                    <div class="col-sm-10">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="home-banner">
                                                        <img src="http://7xp47i.com1.z0.glb.clouddn.com/banner-1.jpg"
                                                             alt="" class="home-slider">
                                                    </div>
                                                </td>
                                                <td>http://www.google.com/huli</td>
                                                <td>2</td>
